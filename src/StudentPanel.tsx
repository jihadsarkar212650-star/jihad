...
const SHOP_PRODUCTS = [
  { id: 1, name: "M10 Wireless Earbuds", price: 450, oldPrice: 850, rating: 4.8, reviews: 124, img: "https://images.pexels.com/photos/3780681/pexels-photo-3780681.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 2, name: "Smart Watch Series 8", price: 1250, oldPrice: 2200, rating: 4.9, reviews: 89, img: "https://images.pexels.com/photos/267394/pexels-photo-267394.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 3, name: "Men's Casual Polo Shirt", price: 380, oldPrice: 650, rating: 4.5, reviews: 230, img: "https://images.pexels.com/photos/259191/pexels-photo-259191.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 4, name: "Laptop Cooling Pad RGB", price: 750, oldPrice: 1200, rating: 4.7, reviews: 56, img: "https://images.pexels.com/photos/400678/pexels-photo-400678.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 5, name: "Wireless Gaming Mouse", price: 950, oldPrice: 1500, rating: 4.6, reviews: 45, img: "https://images.pexels.com/photos/2106216/pexels-photo-2106216.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 6, name: "Backpack Waterproof 35L", price: 1150, oldPrice: 1850, rating: 4.8, reviews: 112, img: "https://images.pexels.com/photos/2905238/pexels-photo-2905238.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 7, name: "Power Bank 20000mAh", price: 1850, oldPrice: 2800, rating: 4.9, reviews: 210, img: "https://images.pexels.com/photos/6633920/pexels-photo-6633920.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 8, name: "Electric Hair Trimmer", price: 650, oldPrice: 1100, rating: 4.4, reviews: 67, img: "https://images.pexels.com/photos/3993437/pexels-photo-3993437.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 9, name: "Bluetooth Soundbar 40W", price: 3200, oldPrice: 4500, rating: 4.7, reviews: 34, img: "https://images.pexels.com/photos/1034651/pexels-photo-1034651.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 10, name: "Smartphone Tripod 50 inch", price: 420, oldPrice: 750, rating: 4.3, reviews: 98, img: "https://images.pexels.com/photos/3394651/pexels-photo-3394651.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 11, name: "Mechanical Keyboard RGB", price: 2800, oldPrice: 4200, rating: 4.9, reviews: 156, img: "https://images.pexels.com/photos/3920181/pexels-photo-3920181.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 12, name: "Air Purifier Ionizer", price: 4500, oldPrice: 6500, rating: 4.6, reviews: 23, img: "https://images.pexels.com/photos/4050212/pexels-photo-4050212.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 13, name: "Leather Wallet for Men", price: 550, oldPrice: 950, rating: 4.5, reviews: 178, img: "https://images.pexels.com/photos/4452533/pexels-photo-4452533.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 14, name: "Stainless Steel Water Bottle", price: 350, oldPrice: 550, rating: 4.4, reviews: 45, img: "https://images.pexels.com/photos/1188649/pexels-photo-1188649.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 15, name: "Office Executive Chair", price: 8500, oldPrice: 12000, rating: 4.8, reviews: 12, img: "https://images.pexels.com/photos/1957477/pexels-photo-1957477.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 16, name: "Premium Coffee Mug", price: 250, oldPrice: 450, rating: 4.2, reviews: 342, img: "https://images.pexels.com/photos/1170659/pexels-photo-1170659.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 17, name: "Digital Thermometer", price: 180, oldPrice: 250, rating: 4.1, reviews: 54, img: "https://images.pexels.com/photos/3786157/pexels-photo-3786157.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 18, name: "LED Desk Lamp USB", price: 850, oldPrice: 1350, rating: 4.5, reviews: 29, img: "https://images.pexels.com/photos/1112598/pexels-photo-1112598.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 19, name: "Kitchen Knife Set 6pcs", price: 1250, oldPrice: 2100, rating: 4.6, reviews: 18, img: "https://images.pexels.com/photos/2012028/pexels-photo-2012028.jpeg?auto=compress&cs=tinysrgb&w=400" },
  { id: 20, name: "Electric Kettle 2.0L", price: 1100, oldPrice: 1650, rating: 4.7, reviews: 82, img: "https://images.pexels.com/photos/3805374/pexels-photo-3805374.jpeg?auto=compress&cs=tinysrgb&w=400" },
];

const CATEGORIES = [
  { title: "Email Marketing", count: 0, img: "https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Video Editing.", count: 0, img: "https://images.pexels.com/photos/257904/pexels-photo-257904.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Form Fill-up.", count: 0, img: "https://images.pexels.com/photos/1620760/pexels-photo-1620760.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Data Entry.", count: 0, img: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Typing Work.", count: 0, img: "https://images.pexels.com/photos/374820/pexels-photo-374820.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Digital Marketing.", count: 0, img: "https://images.pexels.com/photos/265087/pexels-photo-265087.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Graphic Designing.", count: 0, img: "https://images.pexels.com/photos/3184328/pexels-photo-3184328.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Product Selling.", count: 0, img: "https://images.pexels.com/photos/135620/pexels-photo-135620.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Computer Course.", count: 0, img: "https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Facebook Marketing.", count: 0, img: "https://images.pexels.com/photos/607812/pexels-photo-607812.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Gaming Marketing.", count: 0, img: "https://images.pexels.com/photos/442576/pexels-photo-442576.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Spoken English.", count: 0, img: "https://images.pexels.com/photos/256417/pexels-photo-256417.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Namaz & Quran Shikkha", count: 0, img: "https://images.pexels.com/photos/2233416/pexels-photo-2233416.jpeg?auto=compress&cs=tinysrgb&w=800" },
  { title: "Photo Editing.", count: 1, img: "https://images.pexels.com/photos/414548/pexels-photo-414548.jpeg?auto=compress&cs=tinysrgb&w=800" },
];
...
function MyHomeworks() {
  ...
  const homeworks = [
    ...
    { title: "Typing Work.", status: "Continue", color: "bg-cyan-500", img: "https://images.pexels.com/photos/374820/pexels-photo-374820.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { title: "Digital Marketing.", status: "Continue", color: "bg-cyan-500", img: "https://images.pexels.com/photos/265087/pexels-photo-265087.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { title: "Graphic Designing.", status: "Continue", color: "bg-cyan-500", img: "https://images.pexels.com/photos/3184328/pexels-photo-3184328.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { title: "Product Selling.", status: "Continue", color: "bg-cyan-500", img: "https://images.pexels.com/photos/135620/pexels-photo-135620.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { title: "Computer Course.", status: "Continue", color: "bg-cyan-500", img: "https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { title: "Facebook Marketing.", status: "Continue", color: "bg-cyan-500", img: "https://images.pexels.com/photos/607812/pexels-photo-607812.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { title: "Gaming Marketing.", status: "Continue", color: "bg-cyan-500", img: "https://images.pexels.com/photos/442576/pexels-photo-442576.jpeg?auto=compress&cs=tinysrgb&w=800" },
