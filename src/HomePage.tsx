            ...
            {settings?.socialLinks && (
              <div className="flex justify-center items-center gap-4">
                {settings.socialLinks.facebook && (
                  <a href={settings.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-900 text-blue-500 rounded-full hover:bg-blue-600 hover:text-white transition-all shadow-lg hover:-translate-y-1">
                ...
                {settings.socialLinks.youtube && (
                  <a href={settings.socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-900 text-red-500 rounded-full hover:bg-red-600 hover:text-white transition-all shadow-lg hover:-translate-y-1">
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
                ...
                {settings.socialLinks.telegram && (
                  <a href={settings.socialLinks.telegram} target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-900 text-sky-500 rounded-full hover:bg-sky-500 hover:text-white transition-all shadow-lg hover:-translate-y-1">
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
                ...
                {settings.socialLinks.whatsapp && (
                  <a href={settings.socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-900 text-green-500 rounded-full hover:bg-green-500 hover:text-white transition-all shadow-lg hover:-translate-y-1">
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
                ...
                {settings.socialLinks.gmail && (
                  <a href={settings.socialLinks.gmail} target="_blank" rel="noopener noreferrer" className="p-3 bg-gray-900 text-red-500 rounded-full hover:bg-red-500 hover:text-white transition-all shadow-lg hover:-translate-y-1">
